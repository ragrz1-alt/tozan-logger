        ...
        <div style={{ padding: '1.5rem 1.75rem', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          ...
          <section>
            ...
            <p style={{ fontSize: '0.9rem', lineHeight: 1.6, color: 'var(--text-secondary)', margin: 0 }}>
              本システムは、利尻山の2大登山コース（<strong>鴛泊コース・沓形コース</strong>）に設置された赤外線・定点通過カウンターのログデータを集約し、日付および時間帯（24時間）単位での「入山者・下山者」の動向を高精度に可視化します。クラウド同期により、誰でも最新の統計データおよび気象影響をシームレスに確認可能です。
            </p>
          </section>
